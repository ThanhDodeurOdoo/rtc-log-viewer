(function (exports) {
    ...
    function signalType(type) {
        return function validateSignal(context) {
            if (typeof context.value !== "function") {
    ...
    function signal(value, options = {}) {
        return buildSignal(value, (atom) => atom.value, options);
    }
    ...
    signal.Object = function (initialValue, options) {
        return buildSignal(initialValue, (atom) => proxifyTarget(atom.value, atom), options);
    };
    ...
    class Resource {
        ...
        add(item, options = {}) {
            ...
            this._items().push([(_a = options.sequence) !== null && _a !== void 0 ? _a : 50, item]);
            return this;
        }
        delete(item) {
    ...
    class Registry {
        ...
        addById(item, options = {}) {
            ...
            return this.add(item.id, item, { sequence: (_a = options.sequence) !== null && _a !== void 0 ? _a : 50 });
        }
        add(key, value, options = {}) {
            ...
            this._map()[key] = [(_a = options.sequence) !== null && _a !== void 0 ? _a : 50, value];
            return this;
        }
    ...
    function providePlugins(pluginConstructors, inputs) {
        const node = getCurrent();
    ...
    __info__.date = '2026-01-29T09:05:14.533Z';
    __info__.hash = 'fe9c0eb';
